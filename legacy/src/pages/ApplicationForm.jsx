              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <div className="p-8">
                  ...
                  <TabsContent value="academic" className="mt-0 space-y-6">
                    ...
                    {['grade_12', 'bachelor', 'master', 'phd'].includes(formData.highest_education) && (
                      <div className="pt-6 border-t">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          <div><Label>Institution *</Label><Input value={formData.grade_12_institution} onChange={(e) => updateField('grade_12_institution', e.target.value)} className="mt-2" /></div>
                    ...
                    {['bachelor', 'master', 'phd'].includes(formData.highest_education) && (
                      <div className="pt-6 border-t">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          <div><Label>Degree *</Label><Input value={formData.bachelor_degree} onChange={(e) => updateField('bachelor_degree', e.target.value)} placeholder="B.Tech" className="mt-2" /></div>
                          <div><Label>Field *</Label><Input value={formData.bachelor_field} onChange={(e) => updateField('bachelor_field', e.target.value)} className="mt-2" /></div>
                          ...
                          <div><Label>Scale</Label><Input type="number" step="0.1" value={formData.bachelor_scale} onChange={(e) => updateField('bachelor_scale', e.target.value)} placeholder="4.0" className="mt-2" /></div>
                        </div>
                        <div className="mt-4 space-y-3">
                    ...
                    {['master', 'phd'].includes(formData.highest_education) && (
                      <div className="pt-6 border-t">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          <div><Label>Degree</Label><Input value={formData.master_degree} onChange={(e) => updateField('master_degree', e.target.value)} placeholder="M.Tech" className="mt-2" /></div>
                          <div><Label>Field</Label><Input value={formData.master_field} onChange={(e) => updateField('master_field', e.target.value)} className="mt-2" /></div>
                          ...
                          <div><Label>Scale</Label><Input type="number" step="0.1" value={formData.master_scale} onChange={(e) => updateField('master_scale', e.target.value)} className="mt-2" /></div>
                        </div>
                        <div className="mt-4 space-y-3">
                          <DocumentUploadSection section="master_documents" docType="degree" label="Master's Degree Certificate" />
                          <DocumentUploadSection section="master_documents" docType="transcript" label="Master's Transcripts" />
                        </div>
                      </div>
                    )}
                  </TabsContent>
                  ...
                  <TabsContent value="tests" className="mt-0 space-y-6">
                    <p className="text-slate-600">Provide standardized test scores (if available)</p>
          ...
          <div className="flex justify-end mt-8">
            <Button onClick={() => submitApplication.mutate(formData)} disabled={submitApplication.isPending} className="px-12 py-6 text-lg bg-blue-600">
              {submitApplication.isPending ? (
                <div className="flex items-center"><div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin mr-2" />Submitting...</div>
              ) : (
                <div className="flex items-center"><CheckCircle className="w-5 h-5 mr-2" />Submit Application</div>
              )}
            </Button>
          </div>
        </div>
