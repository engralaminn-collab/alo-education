        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="text-xl text-white/90">
              Get expert guidance on your study abroad journey - completely free
            </p>
          </div>
        </div>
      </section>
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-slate-600 mb-6">
                    Your consultation request has been submitted successfully. One of our expert counselors will contact you within 24 hours.
                  </p>
                  <Button 
            ...
            >
              <Card className="border-0 shadow-lg">
                <CardHeader className="bg-gradient-to-br from-slate-50 to-white pb-8">
                  ...
                  <CardDescription>
                    Fill out the form below and our expert counselors will reach out to you
                  </CardDescription>
                </CardHeader>
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-8">
                ...
                <Card className="border-0 shadow-md">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-slate-600">Speak with certified counselors</p>
                  </CardContent>
                </Card>
                <Card className="border-0 shadow-md">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-slate-600">No hidden charges or fees</p>
                  </CardContent>
                </Card>
              </div>
            </motion.div>
