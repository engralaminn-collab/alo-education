...
import AIOutreachAssistant from '@/components/outreach/AIOutreachAssistant';
        ...
        <Tabs defaultValue="personal" className="space-y-6">
          ...
          <TabsContent value="outreach">
            <div className="space-y-6">
              ...
              {studentId && (
                <>
                  <AIOutreachAssistant studentId={studentId} />
                </>
              )}
            </div>
          </TabsContent>
          ...
          <TabsContent value="preferences">
            {studentId && <StudentChatbot studentId={studentId} context="profile" />}
            <div className="space-y-6">
              <Card>
                <CardHeader className="flex flex-row items-center justify-between">
