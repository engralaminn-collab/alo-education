...
export default function StudyInIreland() {
  return (
    <div className="min-h-screen bg-slate-50">
      <section className="bg-gradient-to-br from-green-700 to-emerald-700 py-20">
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <Card className="border-0 shadow-xl bg-gradient-to-r from-green-700 to-emerald-700 text-white">
