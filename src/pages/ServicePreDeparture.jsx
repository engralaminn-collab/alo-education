...
import { CheckCircle, Plane, Target, TrendingUp } from 'lucide-react';
import { Link } from 'react-router-dom';
import { createPageUrl } from '@/utils';
import Footer from '@/components/landing/Footer';
import { motion } from 'framer-motion';

export default function ServicePreDeparture() {
  const processSteps = [
    'Travel and packing guidance',
    'Airport and arrival briefing',
    'Living and working rules',
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        >
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-slate-900 mb-4">Pre-Departure Briefing</h1>
            <p className="text-xl text-slate-600">
              Prepare for your journey with comprehensive orientation
            </p>
          </div>
            ...
            <CardContent className="p-8">
              <div className="flex items-start gap-4 mb-6">
                <div className="w-12 h-12 rounded-full bg-education-blue/10 flex items-center justify-center">
                  <Plane className="w-6 h-6 text-education-blue" />
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 mb-3">About This Service</h2>
                  <p className="text-slate-600 leading-relaxed">
                    Our pre-departure briefing prepares students for life abroad, covering travel, settlement, 
          ...
          <Card className="border-2 border-alo-orange bg-gradient-to-br from-education-blue/5 to-alo-orange/5">
            <CardContent className="p-8 text-center">
              <Plane className="w-12 h-12 text-alo-orange mx-auto mb-4" />
              <h3 className="text-2xl font-bold text-slate-900 mb-3">Ready to Fly?</h3>
              <p className="text-slate-600 mb-6">Join our pre-departure orientation session</p>
