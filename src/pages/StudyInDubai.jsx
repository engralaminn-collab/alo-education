...
export default function StudyInDubai() {
  const { data: universities = [] } = useQuery({
    queryKey: ['dubai-universities'],
    queryFn: () => base44.entities.University.filter({ country: 'United Arab Emirates', status: 'active' }, '-ranking', 6),
  });

  const { data: testimonials = [] } = useQuery({
    queryKey: ['dubai-testimonials'],
    queryFn: () => base44.entities.Testimonial.filter({ country: 'United Arab Emirates', status: 'approved' }, '-created_date', 3),
  });

  const whyDubai = [
    'Tax-free income and scholarships',
  ...
  const popularCourses = [
    'Business & Management', 'Engineering', 'Hospitality',
    'Finance', 'IT & Technology', 'Healthcare'
  ];
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-6" style={{ fontFamily: 'Montserrat, sans-serif' }}>
              Study in <span style={{ color: 'var(--alo-orange)' }}>Dubai</span>
            </h1>
            <p className="text-xl mb-8" style={{ fontFamily: 'Open Sans, sans-serif' }}>
              Experience world-class education in a modern, dynamic city with excellent career prospects.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="text-center">
            <Link to={createPageUrl('Universities') + '?country=United Arab Emirates'}>
              <Button variant="outline" style={{ borderColor: 'var(--alo-blue)', color: 'var(--alo-blue)' }}>
                View All Dubai Universities
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-2xl font-bold text-slate-900 mb-2">AED 40,000 - 80,000</p>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-2xl font-bold text-slate-900 mb-2">AED 30,000 - 50,000</p>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-2xl font-bold text-slate-900 mb-2">AED 3,000</p>
                <p className="text-slate-600">approx. (varies)</p>
              </CardContent>
            </Card>
          </div>
        </div>
