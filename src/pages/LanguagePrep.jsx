...
export default function LanguagePrep() {
  ...
  const TestCard = ({ test, type = 'english' }) => (
    <Card 
      className="border-0 shadow-sm transition-all duration-300 h-full hover:shadow-md"
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Hero Section */}
      <section className="py-20" style={{ backgroundColor: '#C8F4D9', position: 'relative', overflow: 'hidden' }}>
