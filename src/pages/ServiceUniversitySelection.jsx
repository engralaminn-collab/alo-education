...
export default function ServiceUniversitySelection() {
  const processSteps = [
    'Academic profile analysis',
    'Course and university shortlisting',
    'Comparison of tuition, ranking, and outcomes',
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        >
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-slate-900 mb-4">University & Course Selection</h1>
            <p className="text-xl text-slate-600">
              Find the perfect university and course match for your future
            </p>
          </div>
            ...
            <CardContent className="p-8">
              <div className="flex items-start gap-4 mb-6">
                <div className="w-12 h-12 rounded-full bg-education-blue/10 flex items-center justify-center">
                  <Building2 className="w-6 h-6 text-education-blue" />
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 mb-3">About This Service</h2>
                  <p className="text-slate-600 leading-relaxed">
                    We help students choose the right university and course that matches academic profile, budget, 
                    visa requirements, and future career opportunities.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="border-2 border-alo-orange bg-gradient-to-br from-education-blue/5 to-alo-orange/5">
            <CardContent className="p-8 text-center">
              <Building2 className="w-12 h-12 text-alo-orange mx-auto mb-4" />
              <h3 className="text-2xl font-bold text-slate-900 mb-3">Ready to Find Your University?</h3>
              <p className="text-slate-600 mb-6">Get your personalized university shortlist</p>
