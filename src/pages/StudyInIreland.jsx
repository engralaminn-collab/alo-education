...
export default function StudyInIreland() {
  const { data: universities = [] } = useQuery({
    queryKey: ['ireland-universities'],
    queryFn: () => base44.entities.University.filter({ country: 'Ireland', status: 'active' }, '-ranking', 6),
  });

  const { data: testimonials = [] } = useQuery({
    queryKey: ['ireland-testimonials'],
    queryFn: () => base44.entities.Testimonial.filter({ country: 'Ireland', status: 'approved' }, '-created_date', 3),
  });

  const whyIreland = [
    'World-class universities with strong industry links',
    '2-year post-study work visa',
    'English-speaking country with friendly culture',
    'Hub for tech giants (Google, Facebook, Apple)',
    'Lower cost of living than UK'
  ];

  const popularCourses = [
    'Computer Science', 'Business', 'Data Analytics',
    'Pharmacy', 'Engineering', 'Finance'
  ];
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-8" style={{ fontFamily: 'Open Sans, sans-serif' }}>
              Experience quality education in the heart of Europe's tech hub with welcoming communities and rich cultural heritage.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="text-center">
            <Link to={createPageUrl('Universities') + '?country=Ireland'}>
              <Button variant="outline" style={{ borderColor: 'var(--alo-blue)', color: 'var(--alo-blue)' }}>
                View All Ireland Universities
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-2xl font-bold text-slate-900 mb-2">€10,000 - €25,000</p>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-2xl font-bold text-slate-900 mb-2">€7,000 - €12,000</p>
                <p className="text-slate-600">per year (Dublin higher)</p>
              </CardContent>
            </Card>
