...
export default function ServiceApplicationAssistance() {
  const processSteps = [
    'Document checklist preparation',
    'Application form completion',
    'Submission to universities',
    'Offer letter and CAS support'
  ];
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        >
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-slate-900 mb-4">Application Assistance</h1>
            <p className="text-xl text-slate-600">
              Complete university application support from start to finish
            </p>
          </div>
            ...
            <CardContent className="p-8">
              <div className="flex items-start gap-4 mb-6">
                <div className="w-12 h-12 rounded-full bg-education-blue/10 flex items-center justify-center">
                  <FileText className="w-6 h-6 text-education-blue" />
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 mb-3">About This Service</h2>
                  <p className="text-slate-600 leading-relaxed">
                    Our team handles the complete university application process, ensuring accuracy, compliance, 
          ...
          <Card className="border-2 border-alo-orange bg-gradient-to-br from-education-blue/5 to-alo-orange/5">
            <CardContent className="p-8 text-center">
              <FileText className="w-12 h-12 text-alo-orange mx-auto mb-4" />
              <h3 className="text-2xl font-bold text-slate-900 mb-3">Ready to Apply?</h3>
              <p className="text-slate-600 mb-6">Let us handle your application professionally</p>
