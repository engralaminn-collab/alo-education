...
export default function Layout({ children, currentPageName }) {
  ...
  const crmPages = ['CRMDashboard', 'CRMStudents', 'CRMApplications', 'CRMUniversities', 'CRMCourses', 'CRMInquiries', 'CRMCounselors', 'CRMReports', 'CRMSettings', 'CRMTasks', 'CRMTestimonials', 'CRMAutomation', 'CRMMessages', 'CRMMarketing', 'CRMUniversityOutreach', 'CRMLiveChat'];
